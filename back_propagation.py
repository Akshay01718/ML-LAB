...
class NeuralNetwork:
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.weights_input_hidden = np.random.rand(self.input_size, self.hidden_size) * 0.1
        self.weights_hidden_output = np.random.rand(self.hidden_size, self.output_size) * 0.1
        self.bias_hidden = np.random.rand(1, self.hidden_size) * 0.1
        self.bias_output = np.random.rand(1, self.output_size) * 0.1
...
if __name__ == "__main__":
    ...
    file_path = "/home/cse-ai-05/Desktop/Maria/Iris.csv"
